...
//import sql
$L['import_sql'] = "Import SQL";
$L['import_sql_error'] = "Invalid or malformed SQL create statement.";
$L['import_sql_input_placeholder'] = "Import SQL";
$L['import_sql_input_placeholder_detail'] = "Drop Your SQL DDL Statement i.e create table statement (Only single table allowed), These statements are directly transformed into field.";
$L['import_sql_select_db_tbl'] = "Select Database & Table To Generate SQL DDL. Or Paste Create Table SQL.";
$L['import_sql_select_db_option_hint'] = "Select Database";
$L['import_sql_select_table_option_hint'] = "Select Table";
$L['import_sql_beautify_note_title'] = "Notes";
$L['import_sql_beautify_note'] = "Please beautify/format SQL before paste. Otherwise it may not produce correct result. Use the output of <code>mysqldump</code> or any other such utility(i.e. phpmyadmin) to generate ddl. Sql statements generated by selecting database & table are pre-formatted.";
$L['import_sql_beautify_btn'] = "Beautify";
$L['import_sql_field_guesser_chk'] = "Enable Stupid Field Guesser?";
